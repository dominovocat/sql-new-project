...
const migrateList = [
  require("./20220624130132-create-user"),
  require("./20220627111219-add-password"),
  require("./20220627112816-create-order"),
  require("./20220627114346-create-products"),
  require("./20220627125017-create-category"),
  require("./20220627140306-create-bank-card"),
  require("./20220628114202-create-products-to-orders"),
  ...
  require('./20220628162700-insert-products'),
